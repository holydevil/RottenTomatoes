...
//        textWith = [self.message sizeWithFont:self.messageLabel.font constrainedToSize:CGSizeMake(MAXFLOAT, 20)
//                                lineBreakMode:self.messageLabel.lineBreakMode].width;
//        textWith = [self.message sizeWithAttributes:<#(NSDictionary *)#>]
    } else {
